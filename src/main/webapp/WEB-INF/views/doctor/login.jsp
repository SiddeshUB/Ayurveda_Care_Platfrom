...
<head>
    ...
    <title>Doctor Login - AyurVedaCare</title>
    ...
    <style>
        * {
        ...
        /* Remember & Forgot */
        .form-options, .remember-row, .remember-forgot {
            display: flex;
        ...
        .remember-me span, .checkbox-label {
            color: #666;
            font-size: 13px;
        }
        ...
        /* Submit Button */
        .btn-submit, .btn-doctor-login, .btn-login, .btn-primary {
            width: 100%;
            padding: 14px;
        ...
        .btn-submit::before, .btn-doctor-login::before, .btn-login::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
        ...
        .btn-submit:hover, .btn-doctor-login:hover, .btn-login:hover {
            transform: translateY(-3px);
            box-shadow: 0 15px 35px rgba(45, 74, 45, 0.4);
        }
        
        .btn-submit:hover::before, .btn-doctor-login:hover::before, .btn-login:hover::before {
            left: 100%;
        }
        
        .btn-submit:active, .btn-doctor-login:active, .btn-login:active {
        ...
        .form-footer p, .register-link p {
            color: #888;
            font-size: 13px;
            margin-bottom: 8px;
        }
        
        .form-footer a, .register-link a {
            color: #2d4a2d;
            text-decoration: none;
            font-weight: 600;
            transition: all 0.3s ease;
        ...
        .form-footer a:hover, .register-link a:hover {
            color: #c9a227;
        }
        ...
        <div class="login-container">
            ...
            <div class="login-brand">
                <div class="brand-content">
                    ...
                    <h1 class="brand-title">Doctor Portal</h1>
                    <p class="brand-subtitle">
                        Welcome back! Access your dashboard to manage consultations, prescriptions, and connect with patients.
                    </p>
                    ...
                    <div class="brand-features">
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Schedule and track consultations</p>
                            </div>
                        </div>
            ...
            <div class="login-form-section">
                ...
                <form action="${pageContext.request.contextPath}/doctor/login" method="post">
                    ...
                    <div class="form-options">
                        ...
                        <a href="${pageContext.request.contextPath}/doctor/forgot-password" class="forgot-link">Forgot Password?</a>
                    </div>
                ...
                <div class="form-footer">
                    <p>Don't have an account? <a href="${pageContext.request.contextPath}/doctor/register">Register as Doctor</a></p>
