...
<body>
    ...
    <div class="container">
        ...
        <p>Enter your registered email and phone number to receive a password reset link</p>
        ...
        <form action="${pageContext.request.contextPath}/doctor/forgot-password" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="tel" name="phone" class="form-control" placeholder="Enter your registered phone number" required>
