...
<head>
    ...
    <title>Vendor Login - AyurVedaCare</title>
    ...
    <style>
        * {
        ...
        .remember-me, .checkbox-label, .form-check {
            display: flex;
            align-items: center;
            gap: 8px;
            cursor: pointer;
        ...
        .remember-me input, .checkbox-label input, .form-check-input {
            width: 16px;
            height: 16px;
            accent-color: #2d4a2d;
            cursor: pointer;
        ...
        .remember-me span, .checkbox-label, .form-check-label {
            color: #666;
            font-size: 13px;
        }
        ...
        .btn-submit::before, .btn-login::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
        ...
        .btn-submit:hover::before, .btn-login:hover::before {
            left: 100%;
        }
        ...
        <div class="login-container">
            ...
            <div class="login-brand">
                <div class="brand-content">
                    ...
                    <h1 class="brand-title">Vendor Portal</h1>
                    <p class="brand-subtitle">
                        Welcome back! Manage your products, track orders, and grow your Ayurvedic business.
                    </p>
                    ...
                    <div class="brand-features">
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Add and update your product catalog</p>
                            </div>
                        </div>
                        ...
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                <h4>Track Orders</h4>
                                <p>Monitor all your product orders</p>
                            </div>
                        </div>
                        ...
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                <h4>View Earnings</h4>
                                <p>Check your wallet and earnings</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="login-form-section">
                ...
                <form action="${pageContext.request.contextPath}/vendor/login" method="post">
                    ...
                    <div class="form-options">
                        ...
                        <a href="${pageContext.request.contextPath}/vendor/forgot-password" class="forgot-link">Forgot Password?</a>
                    </div>
                ...
                <div class="form-footer">
                    <p>Don't have an account? <a href="${pageContext.request.contextPath}/vendor/register">Register as Vendor</a></p>
