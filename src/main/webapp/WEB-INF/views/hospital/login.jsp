...
<head>
    ...
    <title>Hospital Login - AyurVedaCare</title>
        ...
        <div class="login-container">
            ...
            <div class="login-brand">
                <div class="brand-content">
                    ...
                    <h1 class="brand-title">Manage Your<br>Ayurvedic Center</h1>
                    <p class="brand-subtitle">
                        Welcome back! Manage your center, view bookings, and connect with patients seeking natural healing.
                    </p>
                    ...
                    <div class="brand-features">
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Monitor all your patient bookings</p>
                            </div>
                        </div>
                        ...
                        <div class="brand-feature">
                            ...
                            <div class="feature-text">
                                <h4>View Reviews</h4>
                                <p>See what patients say about you</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="login-form-section">
                ...
                <form action="${pageContext.request.contextPath}/hospital/login" method="post">
                    ...
                    <div class="form-options">
                        ...
                        <a href="${pageContext.request.contextPath}/hospital/forgot-password" class="forgot-link">Forgot Password?</a>
                    </div>
                ...
                <div class="divider">
                    <span>New to AyurVedaCare?</span>
                </div>
                
                <div class="form-footer">
                    <p>Don't have an account? <a href="${pageContext.request.contextPath}/hospital/register">Register your center</a></p>
