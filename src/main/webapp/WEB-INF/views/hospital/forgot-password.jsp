...
<head>
    ...
    <title>Forgot Password - AyurVedaCare</title>
...
<body>
    ...
    <div class="container">
        ...
        <p>Enter your registered email and contact person phone number to receive a password reset link</p>
        ...
        <form action="${pageContext.request.contextPath}/hospital/forgot-password" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="tel" name="phone" class="form-control" placeholder="Enter contact person phone number" required>
        ...
        <div class="back-link">
            <a href="${pageContext.request.contextPath}/hospital/login">
